...
Figures: figures/main_result.png (sensitivity-matrix heatmap, headline). figures/per_species_rates.png (baseline-config per-species lollipop). figures/substrate_sensitivity.png (Bombus-chain-3-pattern scatter, nside=128 vs nside=64 per species). figures/h_r_map_2020s.png, figures/h_r_map_2030s.png (Iberia maps of decadal-mean daily-mean h_r, with 3.1 h threshold contour).
```
